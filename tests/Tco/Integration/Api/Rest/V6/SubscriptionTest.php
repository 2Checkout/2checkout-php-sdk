...
class SubscriptionTest extends TestCase {
    ...
    public function testCheckAttributes() {
        ...
        $this->assertClassHasAttribute( 'core', 'Tco\Source\Api\Rest\V6\Subscription' );
        $this->assertClassHasAttribute( 'acceptedSearchSubscriptionParams', 'Tco\Source\Api\Rest\V6\Subscription' );
    }
